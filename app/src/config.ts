  ...
  pages: [
    {
      slides: [
        // intro
        {
          ...
          description:
            "NiftyFund offers fractionalized ownership and exposure to <b>Nodes</b>, <b>AI Cryptocurrency Trading</b>, <b>Non-Fungible Tokens (NFTs)</b>, <b>Precious Metals</b> and <b>Real-World Assets (RWAs)</b> thanks to the easy-to-access, revolutionary Proof of Sharing consensus mechanism!",
          button: 'Next',
        },
